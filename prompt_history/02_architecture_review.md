...
- Sanity check the overall architecture and system design, simplifying or modifying as we see fit
- Comprehensive check the low level API against our ISO PTP standard in the knowledge base (read ALL the notes) – "ISO PTP" is a good search term to make sure you find them
