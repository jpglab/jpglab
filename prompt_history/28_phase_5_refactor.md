...
We are now going to attempt **PHASE 5** of the refactor.
...
Our goals at this phase of the refactor (**PHASE 5**):

- [ ] Build `CameraManager` with factory pattern
- [ ] Create high-level `Camera` API
- [ ] Update documentation

Success criteria for this phase of the refactor (**PHASE 5**):

- [ ] `src_new/tests/05_camera.ts`:
    - [ ] tests using Vitest
    - [ ] generic camera definition should work with a connected Sony camera and correctly choose USB transport and sony vendor
    ...
    - [ ] supports all the functions we want
        ...
        - [ ] set OSD mode
        - [ ] retrieve OSD image
- [ ] `bun run test:camera` run the new scripts using Vitest
